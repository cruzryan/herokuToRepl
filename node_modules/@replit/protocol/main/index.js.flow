...
declare var npm$namespace$api: {|
  ...
  IDotReplitEnvVar: Class<api$IDotReplitEnvVar>,
  ...
  DotReplitEnvVar: typeof api$DotReplitEnvVar,
...
declare type api$IFlush = {|
   ...
   * Flush consistency
   */
  consistency?: $Values<typeof api$Flush$Consistency> | null,
|};
...
declare class api$Flush {
   ...
   * Flush consistency.
   */
  consistency: $Values<typeof api$Flush$Consistency>;
  ...
  toJSON(): {|
    [k: string]: any,
  |};
  static Consistency: typeof api$Flush$Consistency;
}
...
declare var api$Flush$Consistency: {|
...
declare class api$DotReplit {
   ...
   * DotReplit orderedEnv.
   */
  orderedEnv: api$DotReplitEnvVar[];
 ...
 */
declare type api$IDotReplitEnvVar = {|
  /**
   * DotReplitEnvVar key
   */
  key?: string | null,
 ...
 */
declare class api$DotReplitEnvVar {
  /**
   * Constructs a new DotReplitEnvVar.
   * @param [properties] Properties to set
   */
  constructor(properties?: api$IDotReplitEnvVar): this;
   ...
   */
  static create(properties?: api$IDotReplitEnvVar): api$DotReplitEnvVar;
